...
7. **Object-store rename/delete semantics must stay explicit.**
   ...
   data must not be deleted or moved accidentally; rename/delete of dirty staged
   paths is blocked until sync or conflict handling resolves them.
